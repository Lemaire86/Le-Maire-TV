...
// CONFIG
// -------------------------------
const JSON_URL = "https://flat-violet-6492.jeanjuniorlemaire.workers.dev/?path=ADULTS/";
...
async function loadJSON() {
    try {
        ...
        listContent.innerHTML = "<p style='padding:20px;'>⚠ Cannot load adults section</p>";
    }
}
