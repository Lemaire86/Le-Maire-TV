...
// CONFIG
// -------------------------------
const JSON_URL = "https://flat-violet-6492.jeanjuniorlemaire.workers.dev/?path=VIDEOS/";
...
async function loadJSON() {
    try {
        ...
        listContent.innerHTML = "<p style='padding:20px;'>⚠ Cannot load videos</p>";
    }
}
