...
// CONFIG
// -------------------------------
const JSON_URL = "https://flat-violet-6492.jeanjuniorlemaire.workers.dev/?path=CARTOONS/";
...
async function loadJSON() {
    try {
        ...
        listContent.innerHTML = "<p style='padding:20px;'>⚠ Cannot load cartoons</p>";
    }
}
...
function loadRoot() {
    ...
    // ROOT = CARTOONS/FILENAME (2 parts)
